...
import { Pill, Shield, Eye, EyeOff, ArrowLeft } from "lucide-react";
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    setTimeout(() => {
      ...
      toast({
        ...
        description: "Welcome to MediTeck Admin Dashboard",
      });
    }, 1500);
  };
      ...
      <div className="hidden w-1/2 bg-gradient-to-br from-primary via-primary to-accent lg:flex lg:flex-col lg:items-center lg:justify-center lg:p-12">
        <div className="max-w-md text-center">
          ...
          <p className="mt-4 text-lg text-primary-foreground/80">
            Full control over your medical store. Manage users, view reports,
